    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[#24252c]/[0.06]">
        ...
        <button
          ...
          className="bg-[var(--ink)] text-white text-xs font-bold px-5 py-2.5 rounded-full hover:bg-[var(--ink-soft)] transition-colors shadow-sm self-start sm:self-auto cursor-pointer"
        >
